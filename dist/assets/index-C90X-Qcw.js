 ...
 */const T=globalThis;class g extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ae(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _}}g._$litElement$=!0,g.finalized=!0,T.litElementHydrateSupport?.({LitElement:g});const Se=T.litElementPolyfillSupport;Se?.({LitElement:g});(T.litElementVersions??=[]).push("4.2.1");class ke extends g{static styles=m`
  ...
  `;render(){return console.log(this.isRequired),d`
    ...
    `}}customElements.define("form-input",Re);class Le extends g{static properties={};constructor(){super()}firstUpdated(){const e=this.shadowRoot.querySelector("dialog");e&&!e.open&&e.showModal()}closeDialog(){this.dispatchEvent(new CustomEvent("close-login",{bubbles:!0,composed:!0})),setTimeout(()=>{const e=this.shadowRoot.querySelector("dialog");e.open&&e.close()},10)}_openRegister(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("open-register",{bubbles:!0,composed:!0,detail:{source:"login"}}))}handleLogin(e){e.preventDefault();const t=this.shadowRoot.getElementById("email"),i=this.shadowRoot.getElementById("password"),s=t?.shadowRoot.querySelector("input")?.value||"",r=i?.shadowRoot.querySelector("input")?.value||"";if(!s||!r){alert("Por favor completa todos los campos");return}const n=new re(null,s,r);this.dispatchEvent(new CustomEvent("login-success",{bubbles:!0,composed:!0,detail:{user:n}})),this.closeDialog()}static styles=m`
  :host {
    display: block;
  }
  dialog {
  ...
  `;render(){return d`
    ...
    `}}customElements.define("espe-register",Pe);class Oe extends g{static properties={};static styles=m`
    .nav-search{
      position: relative;
      display: flex;
      align-items: center;
